...
public class GLGCustHrSendWomenDayCard extends BaseCronJob {

    private Log log = LogFactory.getLog(GLGCustHrSendWomenDayCard.class.getName());
            ...
            if (data.getCounts() > 0) {
                while (data.next()) {
                    ...
                    Hrdata.executeSql(" select  Code from ZlEmployee  where Sex=1 and State=0 " +
                            "");
                    while (Hrdata.next()) {
                        EmpNo = Hrdata.getString("Code");
                        String ConverUrl = "https://image-pub.lexiang-asset.com/common/assets/wish/2022_women_day_1068_455.jpg";
