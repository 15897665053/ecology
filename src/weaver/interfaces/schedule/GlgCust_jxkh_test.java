...
public class GlgCust_jxkh_test  extends BaseCronJob {

    private Log log = LogFactory.getLog(GlgCust_jxkh_test.class.getName());
    ...
    public void OA_purta ()  {
        ...
        data.executeSql(" select * from " +
                " uf_GlgNet_jxkhlb where bm='24' " +
