...
public class GlgCust_jxkh_test1 extends BaseCronJob {

    private Log log = LogFactory.getLog(GlgCust_jxkh_test1.class.getName());
    ...
    public void OA_purta() {
        ...
        data.executeSql("select * from  uf_GlgNet_jxkhlb  a  inner join uf_Empts  b  on a.gh= b.gh " +
